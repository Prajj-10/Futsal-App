            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(transaksi.field.imageUrl),
                  fit: BoxFit.cover,
                ),
              ),
            ),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              DetailItem(title: "Number", value: "${transaksi.number}"),
              DetailItem(title: "Type", value: transaksi.field.type),
              DetailItem(title: "Price", value: "Rs. ${transaksi.field.price}"),
            ],
          ),
        );
      }
